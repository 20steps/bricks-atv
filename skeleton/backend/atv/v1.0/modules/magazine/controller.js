...
bricks.module('brickstv.magazine').controller('BricksTVMagazineController', {
    ...
    resolve: function(stateParams) {
        log.info('BricksTVMagazineController.model',stateParams);
        return bricks.apiLoader.call('/magazine.json');
    ...
    action: function(model) {
        log.info('BricksTVMagazineController.action',model)
        return model.data;
    }
