...
bricks.module('brickstv.start').controller('BricksTVStartController', {
    ...
    resolve: function(stateParams) {
        log.info('BricksTVStartController.resolve',stateParams);
        return bricks.apiLoader.call('/start.json?id='+stateParams.id);
